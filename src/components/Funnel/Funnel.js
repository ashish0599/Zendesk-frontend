...
const Funnel = (props) => {
  ...
  return (
    <div className='w-full flex flex-col items-center justify-center'> 
      <h1 className="text-xl lg:text-3xl font-bold mb-4 lg:mb-10">Sales Funnel</h1>
      <div onClick={() => setShowLeadCount(!showLeadCount)} id="lead" className="flex justify-center items-center cursor-pointer h-12 lg:h-16 bg-blue-600 hover:bg-blue-700 w-4/5 mb-2 lg:mb-5 rounded-xl">
      ...
      <div onClick={() => setShowContactedCount(!showContactedCount)} id="contacted" className="flex justify-center items-center cursor-pointer h-12 lg:h-16 bg-blue-400 hover:bg-blue-500 w-3/4 mb-2 lg:mb-5 rounded-xl">
      ...
      <div onClick={() => setShowDiligenceCount(!showDiligenceCount)} id="diligence" className="flex justify-center items-center cursor-pointer h-12 lg:h-16 bg-green-400 hover:bg-green-500 w-3/5 mb-2 lg:mb-5 rounded-xl">
      ...
      <div onClick={() => setShowClosedCount(!showClosedCount)} id="closed" className="flex justify-center items-center cursor-pointer h-12 lg:h-16 bg-green-700 hover:bg-green-800 w-2/4 mb-2 lg:mb-5 rounded-xl">
      ...
      <div onClick={() => setShowRejectedCount(!showRejectedCount)} id="rejected" className="flex justify-center items-center cursor-pointer h-12 lg:h-16 bg-red-600 hover:bg-red-700 w-2/4 mb-2 lg:mb-5 rounded-xl">
